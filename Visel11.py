...
slova = ["виселица", "смартфон", "маргарин", "мегагерц", "страница", "креветка", "микрофон", "автограф", "болтовня", "валежник", "диверсия", "живопись", "косточка", "листопад", "мартышка", "ненастье", "скороход", "тростник", "фисташка", "хоккеист", "царапина", "чаепитие", "шифровка","щедрость", "эмульсия", "языковед"]
